  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-28 h-1 bg-accent mx-auto rounded-full mt-5 mb-5" />
      ...
      >
        ...
        >
          ...
          >
            ...
            <div>
              <h4 className="text-2xl font-display text-white mb-1">
                WhatsApp
              </h4>
          ...
          >
            ...
            <div className="bg-orange-500/10 p-4 rounded-2xl">
              <Clock3 className="w-7 h-7 text-accent" />
            </div>
          ...
          >
            ...
            <div>
              <h4 className="text-2xl font-display text-white mb-3">
                Location
              </h4>
